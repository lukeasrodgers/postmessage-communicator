(function() {
  ...
  var PMC = function(config) {
    ...
    var sendables = this.sender ? this.sender.sendables || [] : [];
    this.create_senders(sendables);
  ...
  PMC.prototype.create_senders = function(sendables) {
    ...
    var make_fn = function(fn_name) {
      return function() {
        that.recipient.postMessage({fn_name: fn_name, fn_args: Array.prototype.slice.call(arguments, 0)}, '*');
      };
    };
  ...
  PMC.prototype.create_listener = function() {
    ...
    add_listener(function(e) {
      ...
      if (fn_name === 'instantiate') {
        ...
        var constructor_name = fn_args[0];
        fn_args = Array.prototype.slice.call(fn_args[1], 0);
        var Constructor = eval(constructor_name);
        that.sender = construct(Constructor, fn_args);
        that.sender.set_communicator(that);
